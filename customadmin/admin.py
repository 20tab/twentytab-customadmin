...
from customadmin.models import CustomAdmin, CustomApp, CustomLink, CustomModel
from image_ui.admin import AdminThumbnail, ColorBoxPositionAdmin
from django.conf import settings
from customadmin.utils import list_apps, list_models
...
class CustomModelAdmin(ColorBoxPositionAdmin):
    ...
    class Media:
        js = ColorBoxPositionAdmin.Media.js + (u'{}customadmin/js/custommodel.js'.format(settings.STATIC_URL),)
